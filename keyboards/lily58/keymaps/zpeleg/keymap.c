...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, LT(_SHORTCUTS, KC_LBRC),  LCTL_T(KC_RBRC),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, LSFT(KC_LALT), \
...
[_RAISE] = LAYOUT( \
  ...
  _______, KC_PIPE, _______, KC_GRV, _______, _______, _______, _______, _______, _______, _______,  _______, KC_MPLY, _______, \
                             _______, _______, _______, _______, _______,  _______, _______, _______\
),
